...
public abstract class GeniusOrder
{
    ...
    /// <summary>See <see cref="GeniusApproach.Step"/>.</summary>
    protected static GeniusApproach.Result ApproachCell(
        ComponentGeniusBrain brain, Vector3 target, float reach, ref int stuckCount, int retries = 2) =>
        GeniusApproach.Step(brain, target, reach, ref stuckCount, retries);
