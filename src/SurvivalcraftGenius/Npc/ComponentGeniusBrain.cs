...
public abstract class GeniusOrder
{
    ...
    /// <summary>Outcome of one <see cref="ApproachCell"/> tick.</summary>
    protected enum Approach
    {
    ...
    /// </summary>
    protected static Approach ApproachCell(
